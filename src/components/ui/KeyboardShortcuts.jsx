...
import { Keyboard, X, Command, ArrowUp, CornerDownLeft } from 'lucide-react';
...
const shortcuts = [
  ...
  },
  {
    category: 'Navigation',
    items: [
      { keys: ['⌘', '1'], description: 'Casual workspace' },
      { keys: ['⌘', '2'], description: 'Work workspace' },
      { keys: ['⌘', '3'], description: 'Code workspace' },
      { keys: ['⌘', '4'], description: 'Private workspace' },
  ...
  },
  {
    category: 'Emergency',
    items: [
      { keys: ['⌘', '⇧', 'P'], description: 'Panic mode (hide app)' },
    ]
  }
];

const KeyBadge = ({ children }) => (
  <span className="inline-flex items-center justify-center min-w-6 h-6 px-1.5
    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            <div className="bg-[#0a0a14]/95 backdrop-blur-xl rounded-2xl
...
// Hook to toggle keyboard shortcuts modal
