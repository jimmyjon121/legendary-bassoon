...
import { NPUModelConverter } from './NPUModelConverter';
...
function HardwareSettings() {
  ...
  return (
    <div className="space-y-6">
      ...
      <SparkSettings
        visible={isSparkHardware || profile === 'spark'}
        sparkProbe={sparkProbe}
        sparkProbeBusy={sparkProbeBusy}
        onRunSparkProbe={handleRunSparkProbe}
      />
